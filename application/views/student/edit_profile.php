<div class="sm-grid">
      <div class="class-list">
        ...
        <label for="course_name" style="font-size: 16px">Fullname</label>
          <input type="text" value="<?= $student["fullname"]?>" name="txtFname" required="" id="course_name">
          
        <label for="course_name" style="font-size: 16px">Email</label>
          <input type="email" value="<?= $student["email"]?>" name="txtEmail" required="" id="course_name">
      ...
      <div class="class-list">
        ...
        <hr>
        <form action="<?= base_url()?>student_change_password" method="POST">
