...
<section>
    ...
    <div class="container-fluid">
        <div class="row form">
            ...
            <div class="col-lg-5 col-md-5 col-sm-8 col-xs-8 instructor-signupForm" style="margin-top: 6%; margin-bottom: 5%;">
                <h2 class="text-center text-light" style="margin-bottom: 10%">Teacher's Signup</h2>
                
                <?= $status ?>
                <?= form_open() ?>

                    <div class="form-group">
                        <input type="text" value="<?= set_value('txtFname')?>" name="txtFname" placeholder="Fullname" class="form-control" required="">
                    </div>
                    ...
                    <div class="form-group text-center text-light">
                        <span style="font-size: 1.2em">Already have an account? <span> <a href="<?= base_url() ?>teacher/signin" style="color: #fff; font-weight: bold;">Signin Here</a>
                    </div>
                <?= form_close()?>
